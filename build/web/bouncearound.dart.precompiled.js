...
function dart_precompiled($collectedClasses) {
  ...
  function ballObject(left, top, size, dir, ballElement) {
    this.left = left;
    this.top = top;
    this.size = size;
    this.dir = dir;
